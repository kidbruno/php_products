...
<!-- Header -->
  ...
  <main class="content">
    ...
    <form method="POST" action="/adicionar_categoria">

      @csrf
      <div class="input-field">
        <label for="category-name" class="label">Nome</label>
        <input type="text" id="category-name" name="category_name" class="input-text" />

      </div>
      <div class="input-field">
        <label for="category-code" class="label">Código</label>
        <input type="text" id="category-code" name="category_code" class="input-text" />
