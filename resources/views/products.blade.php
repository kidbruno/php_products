...
<!-- Header --><body>
  ...
  <main class="content">
    <div class="header-list-page">
      ...
      <a href="{{'adicionar_produto'}}" class="btn-action">Adicionar Produto</a>
    </div>
    <table class="data-grid">
      <tr class="data-row">
        ...
        @foreach ($produtos as $produto)
          ...
          @php
              // $categoria = new \App\Models\Produtos;
              // $categoria->whereHas('categoria_id', $produto->id);
          ...
          <tr class="data-row">
            ...
            {{-- @if($produtos->email)
              @php $validate = new App\Http\Controllers\ProdutoController @endphp
              @if($validate->validaEmail($email))
                <td class="data-grid-td">
                  <span class="data-grid-cell-content">{{$produto->email}}</span>
                </td>
              @endif
            @endif --}}
            ...
            <td class="data-grid-td">
              ...
              <span class="data-grid-cell-content">{{$produto->categorias->nome}}</span>
            </td>

            <td class="data-grid-td">
              <div class="actions">
                <div class="action edit"><a href="/editar_produto/{{$produto->produto_id}}"><span>Edit</span></a></div>
                <div class="action delete"><a href="/deletar_produto/{{$produto->produto_id}}"><span>Delete</span></a></div>
              </div>
            </td>
          </tr>
        @endforeach
